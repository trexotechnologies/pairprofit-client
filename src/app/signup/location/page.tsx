...
import LocationAvailabilityForm from '@/components/onboarding/LocationAvailabilityForm';
...
export default function LocationAvailabilityPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col md:flex-row bg-white overflow-x-hidden">
      ...
      <div className="relative w-full md:w-1/2 flex flex-col bg-white min-h-screen items-center py-8 md:py-14 px-6 md:px-12">
