      ...
      <div className="flex flex-col items-center text-center w-full">
        ...
        <div className="mb-12">
          <p className="text-sm text-gray-400 font-medium">
            Didn't receive code?{' '}
            <Button 
              variant="link" // Use link variant for a text-like button
              className={`font-bold p-0 h-auto text-sm ${timer === 0 ? 'text-[#1680ab] hover:underline' : 'text-[#1680ab]/70'}`}
              disabled={timer > 0}
            >
        ...
        <Button
          ...
          disabled={!isComplete}
          className="w-full text-[16px] border-none"
          size="xl"
          pill
