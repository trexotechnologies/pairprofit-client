...
const ForgotPassword = dynamic(() => import('./ForgotPassword'), { ssr: false });
const ForgotPasswordOTP = dynamic(() => import('./ForgotPasswordOTP'), { ssr: false });
const CreateNewPassword = dynamic(() => import('./CreateNewPassword'), { ssr: false });
  ...
  return (
    <>
      ...
      <div className={`w-full max-w-2xl px-4 transition-all duration-500 ${forgotPasswordStep !== 'LOGIN' ? 'opacity-20 blur-[2px] pointer-events-none scale-[0.98]' : 'opacity-100 scale-100'}`}>
        ...
        {/* Header Section */}
        <div className="mb-6 text-center md:text-center mt-8">
          <h1 className="text-2xl md:text-3xl font-extrabold text-[#0b4d6b] mb-1 leading-tight">
            Welcome back!
          </h1>
        ...
        <div className="space-y-4">
          ...
          <div className="pt-3">
            <Button
              className="w-full text-[16px] border-none shadow-premium"
              size="xl"
            >
              Login
            </Button>
          ...
          <div className="relative flex items-center py-4">
            ...
            <span className="flex-shrink mx-5 text-gray-400 text-[10px] font-extrabold uppercase tracking-[0.2em] opacity-60">OR</span>
            <Separator className="flex-grow" />
          </div>

          {/* Social Authentication */}
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center gap-3 px-6 py-3 border border-gray-100 rounded-full hover:bg-gray-50 transition-all h-[50px] bg-white group shadow-sm">
            ...
            <button className="w-full flex items-center justify-center gap-3 px-6 py-3 border border-gray-100 rounded-full hover:bg-gray-50 transition-all h-[50px] bg-white group shadow-sm">
              ...
              <span className="text-sm font-bold text-gray-700 tracking-tight">Continue with LinkedIn</span>
            </button>
            ...
            <button className="w-full flex items-center justify-center gap-3 px-6 py-3 border border-gray-100 rounded-full hover:bg-gray-50 transition-all h-[50px] bg-white group shadow-sm">
              ...
              <span className="text-sm font-bold text-gray-700 tracking-tight">Continue with Facebook</span>
            </button>
          </div>
        </div>
      </div>
